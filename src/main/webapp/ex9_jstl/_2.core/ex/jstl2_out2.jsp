...
<body>
	...
	* Cross-Site Scripting(XSS)
	 ...
	 <c:out value="${test }" escapeXml="true"/> <%-- value="${test }" 또는 value='${test }' 작성할 수 있습니다. --%>
	 <%-- 
	   <c:out>의 escapXml 속성의 기본값은 true이고 html의 특수문자를 해당 코드로 변환합니다.
	   특수문자			코드
	   <			☞	&lt;
	   >			☞	&gt;
	   '			☞	&#039;
	  ...
	  <c:set var="test" value='<script>alert("환영합니다.2")</script>' />
	  <c:out value="${test }"/>
	  
	  <%-- &lt;script&gt;alert(&#039;환영합니다2.&#034;)&lt/script&gt; --%>
