...
<%
	...
	/*
	JaveMail을 사용하여 이메일을 전송하기 위한 3가지 절차는 다음과 같습니다.
	...
	*/
	...
	try{
		...
		//저장한 Properties객체의 값을 세션의 인스턴스를 생성합니다.
		//public static Session getInstance(properties props)
		//Session 클래스는 사용자의 이름, 암호, 메일 서보와 같이
		//메일 서버를 이용하는데 필요한 이메일 계정 정보를 관리합니다.
		Session s = Session.getInstance(properties);
		
		//보내는 메일과 받은 주소를 설정합니다.
		...
		//받는 메일 주소 정보를 설정합니다.
		//Message.RecipientType는 Message 클래스에서 허용하는 수진사 유형을 정의합니다.
