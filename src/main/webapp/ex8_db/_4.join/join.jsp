...
<link href="<%=request.getContextPath()%>/ex8_db/_4.join/css/join.css" rel="stylesheet" type="text/css">
<style>
#message{
 margin-top:-10px;
 margin-bottom:10px;
...
<script src ="<%=request.getContextPath()%>/ex8_db/_4.join/js/jquery-3.6.0.js"></script>
<script src="http://dmaps.daum.net/map_js_init/postcode.v2.js"></script> 
<script src="<%=request.getContextPath()%>/ex8_db/_4.join/js/validate.js" charset="euc-kr"></script>
</head>
<body> 
